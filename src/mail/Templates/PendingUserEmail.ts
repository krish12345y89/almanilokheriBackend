export const PendingUserEmail = (email: string) => {
  return `<!DOCTYPE html>
    <html>
      <head>
        <meta charset="UTF-8" />
      ...
      <body>
        <div class="container">
          ...
          <p>
            ...
            Polytechnic Nilokheri is pending due to partial sign-up on the website.
          </p>
          <p>
            Complete your registration to become a member of our Alumni team. 
