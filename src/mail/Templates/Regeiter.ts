export const Regestered = (name: string) => {
    return `<!DOCTYPE html>
      <html>
        <head>
          <meta charset="UTF-8" />
          <title>Alumni Registered Successfull</title>
          <style>
            body {
        ...
        <body>
          <div class="container">
            ...
            />
            <h1>Registration Scuuessfull</h1>
            <p>
              Dear ${name}, your application for alumni membership to GBN Govt
              Polytechnic Nilokheri has been received. We will reply again about your status
              as soon as possible 
            </p>
            <p>
